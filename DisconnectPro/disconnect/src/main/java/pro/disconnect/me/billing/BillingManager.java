...
public class BillingManager implements PurchasesUpdatedListener {
     ...
     */
    private static final String BASE_64_ENCODED_PUBLIC_KEY = "";
    ...
    public interface BillingUpdatesListener {
        ...
        void onPurchasesFailure(int aFailureCode, boolean aShowError);
    }
    ...
    public BillingManager(Context aContext, final BillingUpdatesListener updatesListener) {
    ...
    public void onPurchasesUpdated(int resultCode, List<Purchase> purchases) {
        if (resultCode == BillingResponse.OK) {
            ...
            mBillingUpdatesListener.onPurchasesFailure(resultCode, false);
        }
    }
     ...
     */
    public void initiatePurchaseFlow(final Activity aActivity, final String skuId, final @SkuType String billingType) {
        initiatePurchaseFlow(aActivity, skuId, null, billingType);
    }

    /**
     * Start a purchase or subscription replace flow
     */
    public void initiatePurchaseFlow(final Activity aActivity, final String skuId, final ArrayList<String> oldSkus,
        ...
        Runnable purchaseFlowRequest = new Runnable() {
            ...
            public void run() {
                ...
                int responseCode = mBillingClient.launchBillingFlow(aActivity, purchaseParams);
                if ( responseCode != BillingResponse.OK){
                    mBillingUpdatesListener.onPurchasesFailure(responseCode, true);
                }
            }
        };
